...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("evolution", "Inspect and manage personal evolution genes",
               "Tools & Skills", args_hint="[list|events|inspect|archive|reset]",
               subcommands=("list", "events", "inspect", "archive", "reset", "help")),
